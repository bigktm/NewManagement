					...
					<div class="step">
						<div class="step-sections steps-onepage">
								...
								<div class="section-content section-customer-information no-mb">
									...
									<div class="fieldset row flex-wrap">
										...
										<div class="field col-md-4 field-required field-third">
											<div class="field-input-wrapper">
												<input placeholder="Số điện thoại" type="text" name="customerMobile" class="validate[required,custom[phone]] field-input customerPointCheck" value="">
											</div>
										</div>
										...
										<div class="field">
											<div class="field-input-wrapper">
												<div class="descriptionCustomer">
													<textarea name="description" class="input" placeholder="Ghi chú" rows="3" style="width: 100%;padding: 5px;border-radius: 4px;transition: all .2s ease-out;"></textarea>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="step-footer text-right">
								<input type="hidden" id="baokimPmMethodId" name="baokimBankPaymentMethodId" value="cod">
								<input type="hidden" name="shipFee" value="0">
								<input type="hidden" id="totalCartMoney" value="398000">
								...
								<div id="form_discount_add">
									<div class="fieldset">
										<div class="field  ">
											...
											<div class="d-flex field-input-btn-wrapper">
									...
									<tbody>
										<tr class="total-line total-line-subtotal">
											...
											<td class="total-line-price">
												<span class="order-summary-emphasis">398.000₫</span>
											</td>
										</tr>
										<tr class="total-line total-line-shipping">
											<td class="total-line-name">Phí vận chuyển</td>
											<td class="total-line-price">
												<span class="order-summary-emphasis" id="ship_fee">0</span>
											</td>
										</tr>
									</tbody>
									<tfoot class="total-line-table-footer">
										<tr class="total-line">
											...
											<td class="total-line-name payment-due">
												<span class="payment-due-price" id="showTotalMoney" value="398000">398.000₫</span>
												<input type="hidden" id="getMn" value="398000">
											</td>
										</tr>
									</tfoot>
								</table>
