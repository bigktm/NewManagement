                    ...
                    <div class="row text-center mb-5 mt-4">
                        <div class="col-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <span class="text-muted">Mạng xã hội</span>
                            </div>
                        </div>
                        <div class="col-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <span class="text-muted">Google Ads</span>
                            </div>
                        </div>
                        <div class="col-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <span class="text-muted">Cửa hàng</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <h6 class="card-title">Bình luận gần đây</h6>
                        <div class="dropdown ms-auto">
                            <a href="#">View All</a>
                        </div>
                    </div>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex">
                                            <div class="dropdown ms-auto">
                                                ...
                                                aria-haspopup="true" aria-expanded="false"><i class="bi bi-three-dots"></i></a>
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="#" class="dropdown-item">Action</a>
                                                    <a href="#" class="dropdown-item">Another action</a>
                                                    <a href="#" class="dropdown-item">Something else here</a>
