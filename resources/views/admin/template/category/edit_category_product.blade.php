                ...
                <div class="position-center col-md-12">
                    ...
                    <form role="form " class="row" action="{{URL::to('/update-category-product/'. $edit_value->category_id)}}" method="post">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea style="resize: none" rows="4" class="form-control" name="category_product_keywords" id="exampleInputPassword1" placeholder="Mô tả danh mục">{{$edit_value->category_keyworks}}</textarea>
                        </div>
